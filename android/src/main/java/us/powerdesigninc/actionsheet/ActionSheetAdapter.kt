...
data class ActionSheetOption(val text: String, val index: Int, val destructive: Boolean) : ActionSheetItem;

class ActionSheetOptionViewHolder(view: View) : RecyclerView.ViewHolder(view)

class ActionSheetAdapter(private val options: List<ActionSheetItem>, private val onSelected: (ActionSheetOption) -> Unit) : RecyclerView.Adapter<ActionSheetOptionViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup,
                                    viewType: Int): ActionSheetOptionViewHolder {
